...
import masterproef.cards.RequirementImplicits.Int2Requirement
import masterproef.cards.RequirementsImplicits.Requirement2Requirements
import masterproef.cards.abilities.Abilities._
import masterproef.actions.Actions._
import masterproef.actions.targets.Targets._
import masterproef.actions.DestroyAction
...
//		new Swamp called "Swamp 03",
	...
	val sorceries: Array[Sorcery] = Array (
//		new Sorcery called "Deathmark"
//			defined_as Destroy target Creature
//			requires 1 * Swamp,
//		new Sorcery called "Mind Rot"
//			defined_as Discard(2) target Player
//			requires 1 * Swamp,
		new Sorcery called "Doom Blade"
			defined_as Destroy target Creature
			requires 1 * Swamp
	)
