 ...
 * shadow ability toevoegen: Creatures with shadow can only block of be blocked by other creatures with shadow
 * 
 */
object Main extends SimpleSwingApplication {
	...
	def top = new MainFrame {
		...
		size = new Dimension(600, 470)
		preferredSize = new Dimension(600, 470)
