...
/**
 * Extending Creature is actually a dirty hack, since the inherited methods should all be overriden by the Decorator.
 * Wouldn't it be better to use a Creature-interface?
 */
